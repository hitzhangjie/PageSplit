...
document.addEventListener('DOMContentLoaded', () => {
    ...
    if(document.getElementById('win_right_urlToJump')) {
        document.getElementById('win_right_urlToJump').value = window.location.href;
    }

    if(document.getElementById("win_right_openTargetUrlBtn")) {
        document.getElementById("win_right_openTargetUrlBtn").addEventListener("click", function() {
            window.location.href=document.getElementById('win_right_urlToJump').value;
        });
    }
